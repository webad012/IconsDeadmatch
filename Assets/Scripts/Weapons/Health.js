...
function OnGUI()
{
	var healthBarWidth : float = Screen.width * 30/100; // 30%
	var healthBarHeight : float = Screen.height * 10/100; // 5%

	GUI.color = Color.red;
	GUI.HorizontalScrollbar(Rect (Screen.width/2 - healthBarWidth/2, 
									Screen.height * 1 / 100, 
									healthBarWidth, 
									healthBarHeight), 
							0, health, 0, maxHealth); //displays a healthbar
}
